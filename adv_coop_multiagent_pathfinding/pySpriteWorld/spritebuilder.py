...
from pySpriteWorld.sprite import MySprite,MovingSprite,RecursiveDrawGroup
...
class SpriteBuilder(object):
    ...
    def buildGroups(self):
        ...
        Grps = OrderedDict( [(gr,self.basicGroupFactory(gr)) for gr in pySpriteWorld.glo.ALL_LAYERS])
